...
<details class="capeet-shout mobile-disclosure" open><summary><strong>Big shout-out to <a href="https://www.capeet.com/gigs_list.html" rel="noopener noreferrer">Capeet</a></strong><span class="disclosure-action" aria-hidden="true"><span class="open-label">Öffnen</span><span class="close-label">Schließen</span></span></summary><div class="capeet-content"><span>für die seit Jahren gepflegte österreichische Gigliste. Diese inoffizielle Ansicht macht sie nur leichter durchsuchbar. Die Quelle wird bewusst nur einmal täglich abgerufen.</span><a class="capeet-cta" href="https://www.capeet.com/gigs_list.html" rel="noopener noreferrer">Original-Gigliste bei Capeet öffnen →</a></div></details>
<details class="status-bar mobile-disclosure" open><summary><span id="header-metadata">Datenstand wird geladen …</span><span class="disclosure-action" aria-hidden="true"><span class="open-label">Öffnen</span><span class="close-label">Schließen</span></span></summary><nav class="status-content" aria-label="Datenstand und Feeds"><span title="Die öffentliche Capeet-Seite wird einmal pro Tag abgefragt; zwischendurch bleibt der zuletzt erfolgreiche Stand online.">Abruf: 1× täglich</span><a href="changes.html">Changelog</a><a href="https://www.capeet.com/gigs_list.html" rel="noopener noreferrer">Capeet Original</a><a href="feed.xml">Gesamt-RSS</a><details class="feed-menu"><summary>Bundesland-RSS</summary><div><a href="feeds/neu-burgenland.xml">Burgenland</a><a href="feeds/neu-karnten.xml">Kärnten</a><a href="feeds/neu-niederosterreich.xml">Niederösterreich</a><a href="feeds/neu-oberosterreich.xml">Oberösterreich</a><a href="feeds/neu-salzburg.xml">Salzburg</a><a href="feeds/neu-steiermark.xml">Steiermark</a><a href="feeds/neu-tirol.xml">Tirol</a><a href="feeds/neu-vorarlberg.xml">Vorarlberg</a><a href="feeds/neu-wien.xml">Wien</a></div></details></nav></details></header>
<main><details class="controls mobile-disclosure" open><summary><h2 id="filter-heading">Termine filtern</h2><span class="disclosure-action" aria-hidden="true"><span class="open-label">Öffnen</span><span class="close-label">Schließen</span></span></summary><div class="controls-body" aria-labelledby="filter-heading">
...
<label>Sortierung <select id="sort" aria-describedby="sort-help"><option value="discovered-desc">Hinzufügungsdatum (neueste zuerst)</option><option value="discovered-asc">Hinzufügungsdatum (älteste zuerst)</option><option value="changed-desc">Zuletzt geändert</option><option value="date-asc">Konzertdatum aufsteigend</option><option value="date-desc">Konzertdatum absteigend</option></select></label><span id="sort-help" class="hint">„Hinzufügungsdatum“ = erstmals von diesem Radar gesehen. „Zuletzt geändert“ = jüngste erkannte Revision.</span><button id="reset" type="button">Zurücksetzen</button></div></div></details>
...
STYLES_CSS = (Path(__file__).resolve().parents[1] / "docs" / "assets" / "styles.css").read_text(encoding="utf-8")
