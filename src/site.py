...
<link rel="stylesheet" href="assets/styles.css"><link rel="stylesheet" href="assets/mobile-banners.css"><script src="assets/app.js" defer></script></head>
...
<details class="capeet-shout collapsible-banner"><summary><strong>Big shout-out to <a href="https://www.capeet.com/gigs_list.html" rel="noopener noreferrer">Capeet</a></strong><span class="banner-chevron" aria-hidden="true"></span></summary><div class="capeet-body"><span>für die seit Jahren gepflegte österreichische Gigliste. Diese inoffizielle Ansicht macht sie nur leichter durchsuchbar. Die Quelle wird bewusst nur einmal täglich abgerufen.</span><a class="capeet-cta" href="https://www.capeet.com/gigs_list.html" rel="noopener noreferrer">Original-Gigliste bei Capeet öffnen →</a></div></details>
<details class="status-bar collapsible-banner"><summary><span id="header-metadata">Datenstand wird geladen …</span><span class="banner-chevron" aria-hidden="true"></span></summary><nav class="status-body" aria-label="Datenstand und Feeds"><span title="Die öffentliche Capeet-Seite wird einmal pro Tag abgefragt; zwischendurch bleibt der zuletzt erfolgreiche Stand online.">Abruf: 1× täglich</span><a href="changes.html">Changelog</a><a href="https://www.capeet.com/gigs_list.html" rel="noopener noreferrer">Capeet Original</a><a href="feed.xml">Gesamt-RSS</a><details class="feed-menu"><summary>Bundesland-RSS</summary><div><a href="feeds/neu-burgenland.xml">Burgenland</a><a href="feeds/neu-karnten.xml">Kärnten</a><a href="feeds/neu-niederosterreich.xml">Niederösterreich</a><a href="feeds/neu-oberosterreich.xml">Oberösterreich</a><a href="feeds/neu-salzburg.xml">Salzburg</a><a href="feeds/neu-steiermark.xml">Steiermark</a><a href="feeds/neu-tirol.xml">Tirol</a><a href="feeds/neu-vorarlberg.xml">Vorarlberg</a><a href="feeds/neu-wien.xml">Wien</a></div></details></nav></details></header>
<main><details class="controls collapsible-banner"><summary><h2 id="filter-heading">Termine filtern</h2><span class="banner-chevron" aria-hidden="true"></span></summary><div class="controls-body" aria-labelledby="filter-heading">
...
MOBILE_BANNERS_CSS = (Path(__file__).resolve().parents[1] / "docs" / "assets" / "mobile-banners.css").read_text(encoding="utf-8")
...
function setupCollapsibleBanners(){const mobile=matchMedia('(max-width:760px)'),banners=[...document.querySelectorAll('.collapsible-banner')],sync=()=>banners.forEach(banner=>banner.open=!mobile.matches);sync();mobile.addEventListener('change',sync)}
...
def generate_site(
    ...
    *,
    ...
    try:
        ...
        atomic_write_text(staging / "assets/mobile-banners.css", MOBILE_BANNERS_CSS)
