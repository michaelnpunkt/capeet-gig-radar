...
<details class="status-bar mobile-disclosure" open><summary><span id="changes-metadata">Änderungen werden geladen …</span><span class="disclosure-action" aria-hidden="true"><span class="open-label">Öffnen</span><span class="close-label">Schließen</span></span></summary><nav class="status-content" aria-label="Seitennavigation"><a href="index.html">← Alle Gigs</a><a href="feed.xml">Gesamt-RSS</a></nav></details></header>
<main><details class="controls change-controls mobile-disclosure" open><summary><h2 id="filter-heading">Änderungen filtern</h2><span class="disclosure-action" aria-hidden="true"><span class="open-label">Öffnen</span><span class="close-label">Schließen</span></span></summary><div class="controls-body" aria-labelledby="filter-heading">
...
</div></details><p id="change-count" class="count" role="status" aria-live="polite">Änderungen werden geladen …</p><div id="changes-results" class="change-days" aria-label="Änderungschronik"></div>
